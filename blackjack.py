...
class Card:
    ...
    def __str__(self):
        ...
        return f"<b>{self.rank}</b>{CARD_FACES.get(self.suit, '')}"
...
class BlackjackGame:
    ...
    def _resolve_insurance(self):
        """Resolves the insurance bet according to 2:1 payout rules."""
        if self.insurance_bet > 0:
            if self.dealer_hand.is_blackjack():
                # Insurance pays 2:1. If player bet 5, they win 10 profit.
